...
import { PenIcon, Videotape } from "lucide-react";
...
export default function page() {
  ...
  return (
    <main className="h-full flex justify-around min-w-max bg-slate-200 py-8 px-44">
      <div className="flex bg-white rounded-sm py-8 px-5 min-w-full">
        <div className="bg-white border-slate-100 border-2 w-[40%] h-fit rounded-lg p-10 flex flex-col justify-center items-center">
          <Image
            src="/hulk.jpeg"
            alt="logo"
            width={150}
